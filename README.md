...
# 🚀 Mercurion Retail Group - Sales Performance Dashboard
...
This Power BI dashboard project is a strategic response to Mercurion's data challenges. It provides a **comprehensive and interactive visualization** of the company’s sales performance across products, regions, customer segments, and sales team demographics.
...
| `COGS`               | Cost of goods sold – expenses directly tied to products  |
...
- **Total Revenue**: ₦8.26 billion  
- **Total COGS (Cost of Goods Sold)**: ₦7.08 billion  
- **Profit**: ₦1.18 billion  
...
- Revenue was relatively flat in Q1 (January–March).
...
The bar chart ranking products by revenue clearly shows **Paseo** as the top-performing product, generating over ₦2.3 billion in revenue—**nearly 28% of all sales**. Close followers include VIT, Velo, Amarilla, Montana, and Carretera.
...
### 👨‍💼 **Revenue by Salesperson Age Category**

This chart examines performance across sales team age demographics. Salespeople in the **Youth (below 30)** and **Adult (30–45)** categories outperform their Elder and Old counterparts.
...
2. **Capitalize on Seasonality**  
   Plan sales initiatives and ad campaigns to align with the evident September–October sales boom.
...
📌 _Built with Microsoft Excel_  
✍️ _Authored by Joshua Akinola_
